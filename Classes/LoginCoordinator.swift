...
public protocol ConfigurationSource {
    ...
    var googleButtonText: String { get }
    var babyMapButtonText: String { get }
    ...
    var shouldShowGoogleButton: Bool { get }
    var shouldShowBabyMapButton: Bool { get }
...
public struct DefaultConfiguration: ConfigurationSource {
    ...
    public var googleButtonText: String
    public var babyMapButtonText: String
    ...
    public var shouldShowGoogleButton: Bool
    public var shouldShowBabyMapButton: Bool
	...
	public init(backgroundImage: UIImage = UIImage(),
		 ...
		 facebookButtonText: String = "Enter with Facebook",
          googleButtonText: String = "Enter with Google",
           babyMapButtonText: String = "Enter with Baby map",
		 ...
		 shouldShowFacebookButton: Bool = true,
          shouldShowGoogleButton: Bool = true,
          shouldShowBabyMapButton: Bool = true,
        ...
        self.googleButtonText = googleButtonText
        self.babyMapButtonText = babyMapButtonText
        ...
        self.shouldShowGoogleButton = shouldShowGoogleButton
        self.shouldShowBabyMapButton = shouldShowFacebookButton
...
open class LoginCoordinator {
    ...
    fileprivate var recoveryCodeViewController: RecoverCodeViewController {
        if _recoveryCodeViewController == nil {
            let viewController = RecoverCodeViewController()
            viewController.delegate = self
            _recoveryCodeViewController = viewController
        }
        return _recoveryCodeViewController!
    }
    fileprivate var _recoveryCodeViewController: RecoverCodeViewController?
    ...
    open func finish(animated: Bool = true) {
        ...
        _recoveryCodeViewController = nil
    }
    ...
    open func checkRecoveryCodeAndLogin(email: String, password: String, recoveryCode: String){
    ...
    open func enterWithGoogle() {
        print("Implement this method in your subclass to handle facebook.")
    }
    open func enterWithBabyMap() {
        print("Implement this method in your subclass to handle facebook.")
    }
...
private extension LoginCoordinator {
    ...
    func goToRecovery(_ email:String) {

        recoveryCodeViewController.email = email
        navigationController.pushViewController(recoveryCodeViewController, animated: true)
    }
...
extension LoginCoordinator: RecoverCodeViewControllerDelegate {
    func didSelectLoginAfterChangePassWord(_ viewController: UIViewController, _ email: String, _ password: String,  _ recoveryCode: String) {
        checkRecoveryCodeAndLogin(email: email, password: password, recoveryCode: recoveryCode)
    }
