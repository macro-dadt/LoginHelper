#
#  Be sure to run `pod spec lint LoginHelper.podspec' to ensure this is a
...
DESC
  ...
  # Or just: s.author    = "macro.dat"
  # s.authors            = { "macro.dat" => "macro.dat@trim-inc.com" }
  # s.social_media_url   = "http://twitter.com/macro.dat"
  ...
  s.source_files  = "Classes", "LoginKit/Classes/**/*"
  s.exclude_files = "LoginKit/Assets/*.{xib,xcassets,png,storyboard,jpg,otf,ttf}"
